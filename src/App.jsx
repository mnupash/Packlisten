...
const BUILTIN_TEMPLATES = [
  {
    id: "bikepacking", name: "Bikepacking", icon: "🚴", color: "#1a1a1a",
    desc: "Mehrtägige Radreise",
    categories: [
      { id: "bekleidung", name: "Bekleidung", icon: "👕", items: [
        "Trikot","Radhose (Bib)","Windjacke","Regenjacke","Helm","Handschuhe",
        "Radsocken","Fahrradschuhe","Sonnenbrille","Basisschicht Langarm",
      ]},
      ...
      { id: "dokumente", name: "Dokumente", icon: "🪪", items: [
    ...
    todos: [
      ...
      { text: "Rad zur Inspektion", tag: "rad" },
      { text: "Reifenluftdruck prüfen", tag: "rad" },
    ]
  },
  {
    id: "starride", name: "Star Ride Paris", icon: "⭐", color: "#185FA5",
    desc: "1000 km, 8 Etappen",
    categories: [
      { id: "bekleidung", name: "Bekleidung", icon: "👕", items: [
        "Trikot x3","Radhose (Bib) x2","Windjacke","Regenjacke","Helm","Handschuhe",
        "Radsocken x3","Fahrradschuhe","Sonnenbrille","Basisschicht Langarm","Casual-Kleidung Abend",
      ]},
      { id: "rad", name: "Rad & Werkzeug", icon: "🔧", items: [
        "Multitool","Flickzeug-Set","Ersatzschlauch x3","Reifenheber x2",
        "Minipumpe","CO2-Patronen","Kettenschloss x3","Kettenoel","Schaltungseinstellung prüfen",
      ]},
      { id: "elektronik", name: "Elektronik", icon: "📱", items: [
        "Garmin Edge 1040","Ladekabel(s)","Powerbank 20000mAh","Smartphone",
        "Garmin Varia Radar","Stirnlampe","GoPro / Kamera",
      ]},
      { id: "nutrition", name: "Verpflegung", icon: "🥗", items: [
        "Energiegels (Etappenvorrat)","Energieriegel","Elektrolyttabletten","Trinkflaschen x2",
        "Isotonik-Pulver","Magnesium","Koffein-Gels für Endspurt",
      ]},
      { id: "hotel", name: "Hotel / Gepäck", icon: "🏨", items: [
        "Reisetasche (Teamtransport)","Wechselkleidung x8","Schlafsachen","Zahnbürste & Paste",
        "Duschgel & Shampoo","Mikrofaser-Handtuch",
      ]},
      { id: "hygiene", name: "Pflege & Erste Hilfe", icon: "🩹", items: [
        "Chamois Creme (groß)","Verbandszeug","Schmerzmittel","Blasenpflaster",
        "Sonnencreme LSF 50","Lippenpflege","Muskelregeneration (Mag/Omega3)",
      ]},
      { id: "dokumente", name: "Dokumente", icon: "🪪", items: [
        "Reisepass / Personalausweis","Kreditkarte","Bargeld EUR + CHF + DKK",
        "Krankenversicherungskarte","Startnummer","Hotelbestätigungen",
      ]},
    ],
    todos: [
      { text: "Anmeldegebühr bezahlt?", tag: "vorbereitung" },
      { text: "Trikot mit Sponsorenlogos bestellen", tag: "bestellen" },
      { text: "Rad zur Inspektion (2 Wochen vor Start)", tag: "rad" },
      { text: "Spendenseite aktualisieren", tag: "vorbereitung" },
      { text: "Teammitglieder Kontaktliste erstellen", tag: "vorbereitung" },
    ]
  },
  {
    id: "sommerurlaub", name: "Sommerurlaub", icon: "🌞", color: "#854F0B",
    desc: "Strandurlaub & Reisen",
    categories: [
      { id: "bekleidung", name: "Bekleidung", icon: "👕", items: [
        "T-Shirts x5","Shorts x3","Badehose / Bikini x2","Abendkleidung","Unterwäsche x7",
        "Socken x5","Sandalen","Sneaker","Sonnenbrille","Sonnenhut / Cap",
      ]},
      { id: "strand", name: "Strand & Pool", icon: "🏖", items: [
        "Sonnencreme LSF 50","After-Sun-Lotion","Strandtuch","Wasserfeste Uhr",
        "Schnorchel-Set","Wasserbeständige Tasche","Flip Flops",
      ]},
      { id: "elektronik", name: "Elektronik", icon: "📱", items: [
        "Smartphone","Ladekabel(s)","Powerbank","Kamera","Adapter (Reisestecker)",
        "Kopfhörer","Kindle / Tablet",
      ]},
      { id: "hygiene", name: "Hygiene", icon: "🧴", items: [
        "Zahnbürste & Paste","Deo","Shampoo & Duschgel","Rasierer","Schmerzmittel",
        "Durchfall-Tabletten","Mückenschutz","Verbandsmaterial",
      ]},
      { id: "dokumente", name: "Dokumente", icon: "🪪", items: [
        "Reisepass","Kreditkarte","Bargeld","Krankenversicherungskarte",
        "Reiseversicherung","Buchungsbestätigungen","Impfpass",
      ]},
    ],
    todos: [
      { text: "Flug / Bahn buchen", tag: "bestellen" },
      { text: "Hotel / Unterkunft buchen", tag: "bestellen" },
      { text: "Reiseversicherung abschließen", tag: "besorgung" },
      { text: "Währung besorgen", tag: "besorgung" },
      { text: "Impfungen prüfen", tag: "besorgung" },
      { text: "Roaming / eSIM aktivieren", tag: "vorbereitung" },
    ]
  },
  {
    id: "backpacking", name: "Backpacking", icon: "🎒", color: "#3B6D11",
    desc: "Mehrtägige Trekking-Tour",
    categories: [
      { id: "bekleidung", name: "Bekleidung", icon: "👕", items: [
        "Merino T-Shirt x2","Wanderhose (zip-off)","Fleecejacke","Hardshell Jacke",
        "Regenhose","Wandersocken x3","Wanderschuhe","Sandalen / Crocs",
        "Mütze","Handschuhe","Sonnenbrille","Buff",
      ]},
      { id: "schlafen", name: "Schlafen & Unterkunft", icon: "🏕", items: [
        "Rucksack (60-70L)","Zelt (ultralight)","Schlafsack (-5°C)","Isomatte / Pad",
        "Inlett / Hüttenschlafsack","Stirnlampe + Ersatzbatterien","Packsäcke / Dry Bags",
      ]},
      { id: "kochen", name: "Kochen & Essen", icon: "🍳", items: [
        "Gaskocher","Gaskartuschen x2","Topf (klein)","Besteck (Titanium)",
        "Feuerzeug","Wasserfilter / Steripen","Trinkflasche x2","Verpflegung (Tagesration)",
      ]},
      { id: "navigation", name: "Navigation & Sicherheit", icon: "🗺", items: [
        "Karte (wasserfest)","Kompass","GPS-Gerät / Smartphone offline","Pfeife",
        "Notfalldecke","Erste-Hilfe-Set","Notfallkontakte notiert",
      ]},
      { id: "hygiene", name: "Hygiene & Pflege", icon: "🩹", items: [
        "Sonnencreme LSF 50","Insektenschutz","Handdesinfektionsmittel","Toilettenpapier",
        "Kelle / Trowel","Zahnbürste & Paste (mini)","Schmerzmittel","Blasenpflaster",
      ]},
      { id: "dokumente", name: "Dokumente", icon: "🪪", items: [
        "Personalausweis / Reisepass","Notgeld","Krankenversicherungskarte",
        "Reiseversicherung","Notrufnummern notiert",
      ]},
    ],
    todos: [
      { text: "Route planen & downloaden (offline)", tag: "vorbereitung" },
      { text: "Wetterbericht prüfen", tag: "vorbereitung" },
      { text: "Gaspatronen besorgen", tag: "besorgung" },
      { text: "Schuhe einlaufen", tag: "vorbereitung" },
      { text: "Notfallkontakt informieren", tag: "vorbereitung" },
    ]
  },
  {
    id: "leer", name: "Leere Liste", icon: "📋", color: "#888",
    desc: "Komplett leer starten",
    categories: [], todos: []
  },
];
...
const buildCatsFromTemplate = (tpl) =>
  tpl.categories.map(c => ({
    id: c.id + "-" + uid(), name: c.name, icon: c.icon,
...
const jsonbin = {
  ...
  async setAll(binId, apiKey, record) {
    const res = await fetch(`https://api.jsonbin.io/v3/b/${binId}`, { method: "PUT", headers: { "Content-Type": "application/json", "X-Master-Key": apiKey }, body: JSON.stringify(record) });
    if (!res.ok) throw new Error("JSONBin write fehlgeschlagen");
  },
  async createBin(apiKey) {
    const res = await fetch("https://api.jsonbin.io/v3/b", { method: "POST", headers: { "Content-Type": "application/json", "X-Master-Key": apiKey, "X-Bin-Name": "Packliste" }, body: JSON.stringify({}) });
    if (!res.ok) throw new Error("Bin erstellen fehlgeschlagen");
...
export default function App() {
  ...
  const persist = async (idx, listMap, todoMap) => {
    if (cloudEnabled) { const r = buildRecord(idx, listMap, todoMap); ls.set("jb-cache", r); await pushToCloud(r); }
    else { ls.set("pack-index", idx); ls.set("pack-lists", listMap); ls.set("pack-todos", todoMap); }
  };

  const selectList = (id) => {
    const { listMap, todoMap } = getStoreMaps();
  ...
  const createList = async () => {
    ...
    const cats = buildCatsFromTemplate(pickedTemplate);
    const tds = buildTodosFromTemplate(pickedTemplate);
    const d = { id, name, categories: cats };
    const idx = [...lists, { id, name }];
    const { listMap, todoMap } = getStoreMaps();
    listMap[id] = d; todoMap[id] = tds;
    setLists(idx); setActiveId(id); setList(d); setTodos(tds);
    await persist(idx, listMap, todoMap);
    setShowTemplatePicker(false); setPickedTemplate(null); setNewListName("");
    setDrawer(false);
  };
  ...
  const saveCurrentAsTemplate = () => {
    ...
    const tpl = {
      id: uid(), name, icon: "⭐", color: "#5F5E5A", desc: "Eigene Vorlage",
      categories: list.categories.map(c => ({ id: c.id, name: c.name, icon: c.icon, items: c.items.map(i => i.name) })),
      todos: todos.map(t => ({ text: t.text, tag: t.tag }))
    };
  ...
  const updateList = async (u) => {
    setList(u); const { listMap, todoMap } = getStoreMaps(); listMap[activeId] = u;
    await persist(lists, listMap, todoMap);
  };
  const updateTodos = async (u) => {
    setTodos(u); const { listMap, todoMap } = getStoreMaps(); todoMap[activeId] = u;
    await persist(lists, listMap, todoMap);
  };
  ...
  const saveSettings = async () => {
    ...
    else { setCreating(true); try { const id = await jsonbin.createBin(key); ls.set("jb-binid", id); setBinId(id); setBinIdInput(id); setSyncMsg("Bin erstellt ✓"); } catch (e) { setSyncMsg(e.message); } setCreating(false); }
    setApiKeyInput("");
  };
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 100, display: "flex", alignItems: "flex-end" }}>
      <div style={{ background: "#fff", borderRadius: "20px 20px 0 0", width: "100%", maxHeight: "85vh", display: "flex", flexDirection: "column", paddingBottom: "env(safe-area-inset-bottom,0px)" }}>
        <div style={{ padding: "16px 20px 12px", borderBottom: "0.5px solid #f0f0f0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <button onClick={() => { setShowTemplatePicker(false); setPickedTemplate(null); setNewListName(""); }} style={{ fontSize: 22, border: "none", background: "none", cursor: "pointer", color: "#999" }}>×</button>
        </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 20px" }}>
          {!pickedTemplate ? (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
                {allTemplates.map(tpl => (
                  <button key={tpl.id} onClick={() => setPickedTemplate(tpl)} style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "14px 14px", borderRadius: 14, border: "1.5px solid #e8e8e8", background: "#fafafa", cursor: "pointer", textAlign: "left", gap: 4 }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                      <span style={{ fontSize: 26 }}>{tpl.icon}</span>
                      {tpl.id !== "leer" && !BUILTIN_TEMPLATES.find(b => b.id === tpl.id) && (
                        <span onClick={(e) => { e.stopPropagation(); deleteCustomTemplate(tpl.id); }} style={{ fontSize: 16, color: "#ccc", lineHeight: 1 }}>×</span>
                      )}
                    </div>
                    <span style={{ fontWeight: 600, fontSize: 15, color: "#111" }}>{tpl.name}</span>
            ...
            <>
              <button onClick={() => setPickedTemplate(null)} style={{ fontSize: 14, color: "#185FA5", border: "none", background: "none", cursor: "pointer", padding: "0 0 12px", display: "flex", alignItems: "center", gap: 4 }}>← Zurück</button>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, padding: "14px", background: "#f8f8f8", borderRadius: 12 }}>
                ...
                <div>
                  <p style={{ margin: 0, fontWeight: 600, fontSize: 16 }}>{pickedTemplate.name}</p>
                  <p style={{ margin: 0, fontSize: 13, color: "#888" }}>{pickedTemplate.desc}</p>
                </div>
              </div>
              <p style={{ fontSize: 14, color: "#888", margin: "0 0 8px" }}>Name der Liste:</p>
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 100, display: "flex", alignItems: "flex-end" }}>
      <div style={{ background: "#fff", borderRadius: "20px 20px 0 0", width: "100%", padding: "20px 20px calc(20px + env(safe-area-inset-bottom,0px))" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          ...
          <button onClick={() => setShowSaveTemplate(false)} style={{ fontSize: 22, border: "none", background: "none", cursor: "pointer", color: "#999" }}>×</button>
        </div>
        <p style={{ fontSize: 14, color: "#888", margin: "0 0 10px" }}>Die aktuelle Liste wird als wiederverwendbare Vorlage gespeichert.</p>
  ...
  return (
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: "#f2f2f7", minHeight: "100svh", display: "flex", flexDirection: "column", maxWidth: 600, margin: "0 auto" }}>
      ...
      {showSaveTemplate && <SaveTemplateModal />}
      ...
      <div style={{ position: "fixed", top: 0, left: 0, bottom: 0, width: 290, background: "#fff", zIndex: 50, transform: drawer ? "translateX(0)" : "translateX(-100%)", transition: "transform 0.25s ease", display: "flex", flexDirection: "column", paddingTop: "env(safe-area-inset-top,0px)" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "12px" }}>
          {lists.map(l => (
            <div key={l.id} style={{ display: "flex", alignItems: "center", padding: "13px 12px", borderRadius: 12, background: activeId === l.id ? "#f0f0f0" : "transparent", marginBottom: 4, cursor: "pointer" }}>
              <span onClick={() => selectList(l.id)} style={{ flex: 1, fontSize: 16, fontWeight: activeId === l.id ? 600 : 400 }}>{l.name}</span>
              <span onClick={(e) => { e.stopPropagation(); deleteList(l.id); }} style={{ fontSize: 22, color: "#ccc", padding: "0 4px" }}>×</span>
            </div>
          ))}
      ...
      <div style={{ background: "#fff", borderBottom: "0.5px solid #e0e0e0", padding: "0 16px", paddingTop: "env(safe-area-inset-top,0px)", position: "sticky", top: 0, zIndex: 30 }}>
        <div style={{ display: "flex", alignItems: "center", height: 52, gap: 12 }}>
          <button onClick={() => setDrawer(true)} style={{ fontSize: 22, border: "none", background: "none", cursor: "pointer", padding: "4px 4px 4px 0", color: "#333" }}>☰</button>
      ...
      {view === "settings" && (
        <div style={{ background: "#fff", margin: 16, borderRadius: 16, padding: 20 }}>
          ...
          <p style={{ fontSize: 13, color: "#888", margin: "0 0 14px", lineHeight: 1.5 }}>Gleiche Daten auf allen Geräten. Konto auf <a href="https://jsonbin.io" target="_blank" rel="noreferrer" style={{ color: "#185FA5" }}>jsonbin.io</a> → API Keys.</p>
        ...
        <div style={{ flex: 1, padding: "16px", paddingBottom: "calc(16px + env(safe-area-inset-bottom,0px))" }}>
          {!list ? (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: 400, gap: 16 }}>
              ...
              <p style={{ margin: 0, fontSize: 16, color: "#888", textAlign: "center" }}>Noch keine Liste vorhanden</p>
            ...
            <>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {list.categories.map(cat => {
                  ...
                  return (
                    <div key={cat.id} style={{ background: "#fff", borderRadius: 16, overflow: "hidden" }}>
                      <div style={{ padding: "12px 16px", background: "#f9f9f9", borderBottom: "0.5px solid #efefef", display: "flex", alignItems: "center", gap: 10 }}>
                        ...
                        <div style={{ width: 40, height: 5, background: "#e5e5e5", borderRadius: 99, overflow: "hidden" }}>
                      ...
                      {cat.items.map(item => (
                        <div key={item.id} onClick={() => toggleItem(cat.id, item.id)} style={{ display: "flex", alignItems: "center", gap: 14, padding: "13px 16px", borderBottom: "0.5px solid #f5f5f5", cursor: "pointer", opacity: item.checked ? 0.4 : 1, minHeight: 52 }}>
                          <C on={item.checked} />
                          <span style={{ fontSize: 16, flex: 1, textDecoration: item.checked ? "line-through" : "none" }}>{item.name}</span>
                          <button onClick={(e) => { e.stopPropagation(); deleteItem(cat.id, item.id); }} style={{ fontSize: 20, border: "none", background: "none", cursor: "pointer", color: "#ddd", padding: "4px" }}>×</button>
                        </div>
                      ))}
